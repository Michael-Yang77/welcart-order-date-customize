...
<main id="main">
  ...
  <?php if($dummy=='dummy'): //ダミーifでいまだけ消す ?>
  ...
  <div class="cakes_list">
    ...
    <?php else: ?>
      <p style="text-align: center; font-weight:bold">次回の予約販売開始までしばらくお待ちください。</p>
      <p style="text-align: center; font-weight:bold">販売予定については以下の予定表をご覧ください。</p>
    <?php endif; ?>
  </div>
  <!-- / cakes_list -->
  ...
  <h2 class="title_marup">販売は終了しました</h2>
  <p style="text-align: center;">今季の販売は終了いたしました。たくさんのご注文ありがとうございました。<br><br><br><br><a href="/">→ TOPにもどる</a><br><br><br><br><br><br></p> 

  <?php endif; //if($dummy='dummy') ?>
