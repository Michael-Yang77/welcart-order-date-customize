	...
	<div class="post" id="wc_<?php usces_page_name(); ?>">
		...
		<div class="entry">
			...
			<?php do_action('usces_action_delivery_page_header'); ?>
				...
				<div style="font-size: 14px; color:#ff0000">※バースデーケーキ（期間限定ケーキ含む）は店舗でのお渡しのみとなります。<br>　ご購入商品にギフト商品とケーキが混在する場合、ギフト商品のみ地方発送させていただきます。</div>
			...
			<?php echo uesces_addressform( 'delivery', $usces_entries ); ?>
				...
				<table class="customer_form" id="time">
					...
					<tr>
						...
						<td colspan="2"><?php usces_the_payment_method( $usces_entries['order']['payment_name']); ?>
					</td>
					</tr>
				</table>
