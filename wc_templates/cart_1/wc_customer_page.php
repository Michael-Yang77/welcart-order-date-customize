	...
	<h1 class="cart_page_title"><?php _e('Customer Information', 'usces'); ?></h1>
		<div class="entry">
			...
			<?php endif; ?>
				...
				<p>ご注文後、<strong style="color: #dd0000">当店からの返信メールをもって受注完了</strong>となります。</p>
				<p>携帯電話のメール設定により、当店からのメールが受信できない場合がございます。
迷惑メール対策をされている方は、<strong>指定受信許可リスト(受信許可)</strong>にメールアドレス<strong style="color: #dd0000">「anneshirley1993@icloud.com」</strong>を追加してください。<br><br>
●設定方法：
<a href="https://www.nttdocomo.co.jp/info/spam_mail/domain/" target="_blank">docomo</a> / 
<a href="https://www.au.com/support/service/mobile/trouble/mail/email/filter/detail/domain/" target="_blank">au</a> / 
<a href="https://www.softbank.jp/mobile/support/mail/antispam/email-i/white/" target="_blank">Softbank</a></p>
