	...
	<div class="post" id="wc_<?php usces_page_name(); ?>">
		...
		<div class="entry">
			...
			<h3><?php _e('It has been sent succesfully.', 'usces'); ?></h3>
				...
				<!--sod<p><?php _e('Thank you for shopping.', 'usces'); ?><br /><?php _e("If you have any questions, please contact us by 'Contact'.", 'usces'); ?></p>-->
				<p>この度は、御買い上げ頂きありがとうございました。<br />
				当日は、 お気を付けてご来店くださいませ。<br />
