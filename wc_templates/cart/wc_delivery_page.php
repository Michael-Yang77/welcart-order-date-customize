...
<?php if (have_posts()) : usces_remove_filter(); ?>
	...
	<div class="post" id="wc_<?php usces_page_name(); ?>">
		...
		<h1 class="cart_page_title"><?php _e('発送方法', 'usces'); ?></h1>
		<div class="entry">
			...
			<?php do_action('usces_action_delivery_page_header'); ?>
				...
				<div style="font-size: 14px; color:#ff0000">※バースデーケーキ（期間限定ケーキ含む）は店舗でのお渡しのみとなります。</div>
...
$(window).on('load', function() {
    ...
    $('.to_confirm_button').click(function(e){
    if($('.delivery_date').val() == 'ご希望日を選んでください'){
    alert('受取希望日を選択する必要があります。');
	e.preventDefault();
