...
<main id="main">
  ...
  <section class="section">
	...
	<ul class="marup_Wrap">
		<li><img src="/assets/img/item/limited/marup/marup_day_10@2x.png"></li>
		<li><a class="btn_to_line" href="https://line.me/R/ti/p/%40593lcbpr" target="_blank">アンシャーリー公式LINEに、<br>登録していただくとお知らせが届きます。</a></li>
	</ul>
	<ul class="marup_Wrap">
		<li style="
			line-height: 1.5rem;
		...
		">
			※ご来店時間について<br>
			皮を剥くと変色しやすい為、ご予約の時間に合わせてお作りしております。<br>
			大幅な時間変更の場合は必ずご連絡をお願い致します。
		</li>
	</ul>
