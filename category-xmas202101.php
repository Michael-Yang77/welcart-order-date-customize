...
<main id="main">
  ...
  <?php
    ...
    $target_day = "2020-11-01 10:00:00";
  
    // target_dayが過去なら ========================================================================= 
    if(strtotime($today) < strtotime($target_day)): 
  ?>    
  <p style="text-align: center;"><img src="/assets/img/item/limited/xmas/xmas_dummy2.jpg"></p>
  <style>
  .page_head{
    display: none;
  }
  ...
  <div class="xmas_info">
    ...
    <div class="xmax_info_inner">
      ...
      <div class="term_web">
        【WEB受付期間】　<br class="pc_disp_no">11月1日（日）～12月15日（火）<br>※売り切れ次第終了となります。ご了承ください。
      </div>
      ...
      <ol class="point">
        ...
        <li>
          キャンセル変更の受付は<strong>12月17日（木）</strong>までとなります。<br>
          それ以降のキャンセルは受付できません。ご了承ください。<br>
          キャンセルの際はご予約していただきました店舗に電話にてお問い合わせください。
        </li>
      </ol>
